...
use Flow\FrontendBundle\Entity\Card;
use Flow\FrontendBundle\Form\CardType;
...
class CardController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FlowFrontendBundle:Card')->findAll();

        return $this->render('FlowFrontendBundle:Card:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FlowFrontendBundle:Card:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FlowFrontendBundle:Card')->find($id);
        ...
        return $this->render('FlowFrontendBundle:Card:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FlowFrontendBundle:Card:edit.html.twig', array(
            'entity'      => $entity,
